var UserConfig = UserConfig || {};  // 确保 UserConfig 已经定义，如果没有就初始化为空对象
...
function initialize_fc_lite() {
  ...
  function processArticles(data) {
      ...
      articles.forEach(article => {
          ...
          date.innerHTML = "<i class='fa-solid fa-clock'></i>" + article.created.substring(0, 10);
  ...
  function showAuthorArticles(author, avatar, link) {
      ...
      authorArticles.slice(0, 4).forEach(article => {
          ...
          date.innerHTML = "<span>" + article.created.substring(0, 10) + "</span>";
